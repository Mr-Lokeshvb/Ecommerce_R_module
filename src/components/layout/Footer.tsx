      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Fashion Era</span>
            </div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                {/* FEATURE_DISABLED_RETURNS_START
                    Returns page link disabled while the return system is wired out.
                    Previous link: <Link to="/returns">Returns & Exchanges</Link>
                FEATURE_DISABLED_RETURNS_END */}
                <span className="text-gray-500">Order Support</span>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 FashionVR. All rights reserved. | 
